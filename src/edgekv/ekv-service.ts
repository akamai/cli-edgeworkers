...
export function createNameSpace(network: string, namespace: string, retention, groupId) {
  var body = { "namespace": namespace, "retentionInSeconds": retention, "groupId": groupId};
