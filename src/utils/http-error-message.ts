export enum ErrorMessage {
    ...
    GET_ACT_CUST_FOR_EW_ERROR = 'ERROR: Unable to retrieve active customers for the specified Edgeworker ID.',
    GET_ACT_CUST_FOR_EW_404 = 'Unable to find the requested active customers.',
    LISTALL_EW_404 = 'Unable to list EdgeWorker IDs.',
